...
def build_server():
    ...
    server.tool()(jobs.search_today_jobs_for_me)
    ...
    server.tool()(jobs.daily_job_digest_for_me)
    server.tool()(jobs.get_digest_history)
    server.tool()(jobs.get_weekly_job_summary)
    server.tool()(jobs.get_job_market_trends)
    server.tool()(jobs.get_resume_gap_analysis)
